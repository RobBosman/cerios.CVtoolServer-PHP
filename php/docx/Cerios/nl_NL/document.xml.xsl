    ...
    <w:document mc:Ignorable="w14 wp14">
      <w:body>
          ...
          <xsl:when test="(($layout != '') and (//cv:businessunit/cv:manager_email) or (//cv:businessunit/cv:manager_telofoonnummer))">
            <w:p w:rsidR="00A47DC9" w:rsidRDefault="004064CD">
              <w:r w:rsidRPr="00BE478D">
                <w:t xml:space="preserve">Voor meer informatie belt of e-mailt u naar <xsl:value-of select="//cv:businessunit/cv:manager_naam" /> via </w:t>
              </w:r>
              ...
              <w:r w:rsidRPr="00BE478D">
                <w:t xml:space="preserve"> of <xsl:value-of select="//cv:businessunit/cv:manager_telefoonnummer" />.</w:t>
              </w:r>
            </w:p>
          </xsl:when>
          <xsl:otherwise>
        ...
        <xsl:if test="$layout != ''">
          ...
          <w:p w:rsidR="00A47DC9" w:rsidRDefault="004064CD">
            <w:r w:rsidRPr="00BE478D">
              <w:t xml:space="preserve">Cerios realiseert succesvolle IT-projecten. Om dit te verwezenlijken versterkt Cerios opdrachtgevers met expertise op het gebied van projectvoering, architectuur &amp; IT en kwaliteitscontrole. De resultaatgerichte professionals van Cerios gaan voor 100% succes. Meer weten? Zie </w:t>
            </w:r>
                ...
                <w:tc>
                  ...
                  <w:p w:rsidR="00A9087A" w:rsidRPr="003C6056" w:rsidRDefault="00A9087A" w:rsidP="00CC5388">
                    ...
                    <w:r w:rsidRPr="003C6056">
                      ...
                      <w:t>Persoonlijke eigenschappen</w:t>
                    </w:r>
                  </w:p>
                </w:tc>
                <w:tc>
        ...
        -->
        <xsl:variable name="branchekennis" select="//cv:branchekennis[normalize-space(cv:omschrijving_NL)]" />
    ...
    <w:tr w:rsidR="00011166" w:rsidRPr="00A731A7" w:rsidTr="00C90161">
      ...
      <w:tc>
        ...
        <w:p w:rsidR="00011166" w:rsidRPr="00A731A7" w:rsidRDefault="00011166" w:rsidP="00C90161">
          ...
          <w:r>
            <w:t>
              <xsl:value-of select="cv:omschrijving_NL" />
            </w:t>
          </w:r>
        </w:p>
      </w:tc>
  ...
  <xsl:template match="cv:publicatie">
    <w:p w:rsidR="00480FB7" w:rsidRPr="00A579DF" w:rsidRDefault="00480FB7" w:rsidP="00C90161">
      ...
      <w:r w:rsidRPr="00BE478D">
        <w:br/>
        <w:t>
          <xsl:value-of select="cv:omschrijving_nl_NL" />
        </w:t>
      </w:r>
    </w:p>
  </xsl:template>
          ...
          <w:tc>
            ...
            <w:p w:rsidR="00480FB7" w:rsidRPr="003C6056" w:rsidRDefault="00480FB7" w:rsidP="00C90161">
              ...
              <w:r w:rsidRPr="003C6056">
                ...
                <w:t>
                  <xsl:choose>
                    <xsl:when test="cv:titel">Titel</xsl:when>
                    <xsl:otherwise>Periode</xsl:otherwise>
                  </xsl:choose>
                </w:t>
              </w:r>
            </w:p>
          ...
          <w:tc>
            ...
            <w:p w:rsidR="00480FB7" w:rsidRPr="00366729" w:rsidRDefault="00480FB7" w:rsidP="00C90161">
              ...
              <w:r w:rsidRPr="003C6056">
                ...
                <w:t>Werkzaamheden en resultaten</w:t>
              </w:r>
            </w:p>
          </w:tc>
          <w:tc>
